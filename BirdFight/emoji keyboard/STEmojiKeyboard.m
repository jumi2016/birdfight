...
#define kSTEmojiKeyboardFrame CGRectMake(0, 0, CGRectGetWidth([UIScreen mainScreen].bounds), 253)
#define kSTEmojiToolBarHeight 35
...
- (void)loadUI{
    ...
    deleteButton.frame = CGRectMake(VIEW_SIZE.width - w, 0, w, h);
