...
@interface DescOneImageActionCell ()
...
@implementation DescOneImageActionCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        self.image_view.layer.cornerRadius = 15;
        ...
        [self.timeLabel mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.mas_equalTo(20);
            make.top.mas_equalTo(weakSelf.image_view.mas_bottom).offset(15);
        ...
        [self.memeBtn mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.top.mas_equalTo(_image_view.mas_bottom).offset(5);
            make.width.mas_equalTo(40);
