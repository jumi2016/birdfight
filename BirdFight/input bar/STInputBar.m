...
#define kSTIBDefaultHeight 30
#define kSTLeftButtonWidth 50
#define kSTLeftButtonHeight 30
#define kSTRightButtonWidth 50
...
- (void)loadUI{
    ...
    self.keyboardTypeButton = [[UIButton alloc] initWithFrame:CGRectMake(0.0f, (44-kSTLeftButtonHeight)/2, kSTLeftButtonWidth, kSTLeftButtonHeight)];
    ...
    self.textView = [[UITextView alloc] initWithFrame:CGRectMake(kSTLeftButtonWidth, (44-kSTTextviewDefaultHeight)/2, CGRectGetWidth(self.frame)-kSTLeftButtonWidth-kSTRightButtonWidth-15, kSTTextviewDefaultHeight)];
    ...
    self.sendButton.frame = CGRectMake(self.frame.size.width-kSTRightButtonWidth-5, 7, kSTRightButtonWidth, kSTIBDefaultHeight);
    self.sendButton.backgroundColor = [UIColor colorWithRed:249/255.0 green:83/255.0 blue:100/255.0 alpha:1];
