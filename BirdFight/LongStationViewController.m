...
@interface LongStationViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation LongStationViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // 按钮传值事件
    if (indexPath.row == 1) {
        __weak __block LongStationViewController * copy_self = self;
